...
namespace Engine
{
    public class ParryingDagger : SideArm
    {
        public ParryingDagger(int id, string name, string description, int goldValue, int healthBonus = 0, int manaBonus = 0, int attackBonus = 0,
